                          ...
                          >
                            <g clipPath="url(#clip0_205_110)">
                              ...
                              <g mask="url(#mask0_205_110)">
                                <path d="M75 0H0V75H75V0Z" fill="white" />
                                <path
                                  d="M50.9907 37.1824C52.9888 38.407 52.9888 41.3074 50.9907 42.532L28.3032 55.9383C26.2407 57.1629 23.6626 55.6805 23.6626 53.2313V26.4187C23.6626 23.7762 26.4341 22.6805 28.3032 23.7762L50.9907 37.1824Z"
                                  fill="#0E6A37"
                                />
                              </g>
                            </g>
              ...
              <div className="grid grid-rows-2 gap-4">
                <div className="relative">
                  ...
                  <div className="absolute top-0 bottom-0 right-0 left-0">
                    <div className="flex justify-center h-full items-center">
                      <button className="hover:scale-110">
                        <ModalVideo videoUrl="https://www.youtube.com/embed/blXNITtzSjM">
                          <svg
                            width="75"
                            height="75"
                            viewBox="0 0 75 75"
