  ...
  return (
    <>
      <section className="relative">
        ...
        <div className="absolute h-32 bottom-0 right-0 left-0 bg-blue-500 opacity-40"></div>
        <div className="absolute h-32 bottom-0 right-0 left-0 border-t-4 border-blue-900 text-white">
          <div className="h-full flex justify-center py-5">
            <span>
              <div className="">Our Impact</div>
              <div className="text-2xl">
                Conserved Water :
                <div className="">
                  <div className="bg-stone-100 bg-opacity-40 rounded-lg px-2 py-1">
                    714,923,129
                  </div>
      ...
      <section className="grid grid-cols-2 gap-3 py-28 items-center" id="about">
        ...
        <div className="flex">
          <div className="flex items-center">
            <Image unoptimized width={100} height={100} src="/foto2.png" alt="foto2" className="w-72" />
          </div>
          <div className="flex items-center ml-3">
            <Image unoptimized width={100} height={100} src="/foto1.png" alt="foto1" className="w-96" />
          </div>
          <div className="flex items-center ml-3">
            <Image unoptimized width={100} height={100} src="/foto3.png" alt="foto2" className="w-72" />
          </div>
        </div>
      </section>
      <section className="relative flex justify-center">
        <div className="w-2/5 relative">
          <Image unoptimized width={100} height={100} src="/background2.png" alt="background2" className="w-full" />
        ...
        <div className="w-1/5 relative overflow-hidden">
          <Image unoptimized width={100} height={100} src="/bg3.png" alt="background2" className="h-full" />
          <div
            className="absolute left-0 right-0 top-0 bottom-0 bg-blue-600 opacity-50"
          ></div>
          <div className="absolute left-0 right-0 top-0 bottom-0">
            <div className="flex h-full justify-center items-center">
              <div className="flex flex-col text-white px-16">
        ...
        <div className="w-1/5 relative overflow-hidden">
          <Image unoptimized width={100} height={100} src="/bg4.png" alt="background2" className="h-full" />
          <div
            className="absolute left-0 right-0 top-0 bottom-0 bg-green-600 opacity-50"
          ></div>
          <div className="absolute left-0 right-0 top-0 bottom-0">
            <div className="flex h-full justify-center items-center">
              <div className="flex flex-col text-white px-16">
        ...
        <div className="w-1/5 relative overflow-hidden">
          <Image unoptimized width={100} height={100} src="/bg5.png" alt="background2" className="h-full" />
          <div
            className="absolute left-0 right-0 top-0 bottom-0 bg-amber-600 opacity-50"
          ></div>
          <div className="absolute left-0 right-0 top-0 bottom-0">
            <div className="flex h-full justify-center items-center">
              <div className="flex flex-col text-white px-16">
      ...
      <section className="flex justify-center py-12" id="portofolio">
        <div className="flex flex-col max-w-7xl">
          <div className="text-center uppercase pts-40" >
            project Portofolio
          </div>
          ...
          <Image unoptimized width={100} height={100} src="/indonesia.png" alt="" />
        </div>
      </section>
      <section className="max-w-7xl mx-auto">
        <div className="grid grid-cols-3 gap-4">
          <div><Image unoptimized width={100} height={100} src="/porto1.png" style={{height:"720px"}} alt="" /></div>
          <div className="grid grid-rows-2 gap-4">
            <div className="">
              <Image unoptimized width={100} height={100} src="/porto2.png" alt="" />
            </div>
            <div className="relative">
              <Image unoptimized width={100} height={100} src="/porto3.png" alt="" />
              <div
                className="absolute left-0 right-0 top-0 bottom-0 bg-blue-600 opacity-30"
              ></div>
              <div
                className="absolute top-12 right-0 left-0 text-center text-white pts-24"
          ...
          <div><Image unoptimized width={100} height={100} src="/porto4.png" style={{height:"720px"}} alt="" /></div>
        </div>
      </section>
      ...
      <section className="flex flex-col justify-center">
        <div
          className="uppercase font-bold text-center mt-14 pts-40"
          
        >
          our Product & Partner
        </div>
        <div className="flex justify-center space-x-9 py-12 mb-36">
          <Image unoptimized width={100} height={100} src="/smi.png" className="h-16" alt="" />
          <Image unoptimized width={100} height={100} src="/aquahelix-mbr-pump.png"  alt="" />
          <Image unoptimized width={100} height={100} src="/aquahelix.png"  alt="" />
          <Image unoptimized width={100} height={100} src="/teco.png"  alt="" />
          <Image unoptimized width={100} height={100} src="/nadic.png"  alt="" />
          <Image unoptimized width={100} height={100} src="/sng.png"  alt="" />
          <Image unoptimized width={100} height={100} src="/yuema.png"  alt="" />
          <Image unoptimized width={100} height={100} src="/transm.png"  alt="" />
        </div>
      </section>
    </>
  );
