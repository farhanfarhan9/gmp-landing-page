...
const GreenView = ({ title, image, nickname, location, desc, url }: Props) => {
  return (
    <>
      ...
      <div className="xl:hidden block-row">
        <div className="grid grid-rows-0 mx-4">
          ...
          />
          <div className="bg-green-800 text-white px-16 py-8">
            <div className="font-semibold my-2 text-sm sm:text-base md:text-lg pts-24">{title}</div>
            <div className="my-1 text-sm sm:text-base md:text-lg">{nickname}</div>
            <div className="flex items-center space-x-2 py-2">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
