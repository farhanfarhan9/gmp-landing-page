  ...
  return (
    <>
      <section className="relative">
          ...
          <div className="h-full">
            <div className="h-full">
              <div className="text-white h-full flex items-center max-w-7xl mx-auto">
                <div className="-mt-36">
                  <div className="font-bold pts-80" style={{lineHeight:"84px"}}>
        ...
        <div className="absolute bottom-0 right-0 left-0 border-t-4 bg-blue-500 bg-opacity-40 border-blue-900 text-white">
