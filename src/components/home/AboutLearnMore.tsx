  ...
  return (
    <>
      ...
      >
        ...
        dengan kepercayaan dari Teco, Ebara, Torishima dan Tsurumi untuk
        membantu pelanggan mereka di seluruh Indonesia untuk penggunaan yang
        tepat mutu dan tepat biaya. Jasa ini terbukti hanya dapat dilakukan oleh
        Satria Nusa dengan pengalaman dan kapabilitas teknik yang lintas
        disiplin. Sehingga Satria Nusa, tidak hanya menjual unit, tetapi menjadi
        mitra dari pelanggan kami untuk investasi yang optimal. Bermodalkan
        pengalaman dan kepercayaan ini, kami didukung oleh para pemilik pabrik,
        akademisi dan principals untuk mengembangkan solusi limbah industri dan
        domestik. Satria Nusa berhasil mengolah limbah dengan pencapaian
        melebihi baku mutu sehingga pada banyak contoh kasus dari pengalaman
        kami dapat digunakan kembali untuk kebutuhan produksi. Satria Nusa
        dipimpin oleh Bapak Feli Zulhendri Msc yang merupakan wastewater
        engineer dari Illnois Institute of Technology, Chicago, USA. Beliau juga
        mempublikasikan jurnal teknis berjudul “Evaluation of the Capability of
        Advanced Treatment Process to Redyce Ultimate BOD and Provide a
        Self-sustaining Effluent with Respect to Dissolved Oxygen”.
      </Transition>
