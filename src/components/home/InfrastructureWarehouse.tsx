...
function InfrastructureWarehouse() {
  ...
  return (
    <div className="relative w-full" id="infrasctructure">
      <Image
        unoptimized
        width={100}
        height={100}
        src={"/img/home/circle.png"}
        className="absolute w-1/2 md:w-1/6 md:-top-16"
        alt=""
      />
      <div className="py-5 mt-5 space-y-10 md:py-10 md:mt-10 md:mx-auto md:max-w-7xl">
        ...
        <div className="grid grid-cols-1 px-2 md:grid-cols-3 gap-14">
          ...
          <div className="w-full pl-6 border-l-2 border-l-[#77C3ED] space-y-5">
            ...
            <p className="">
              Jl. Lau Cimba (Samping Perumahan Graha Harmoni), Pematang Siantar
            </p>
          </div>
          <div className="w-full pl-6 border-l-2 border-l-[#77C3ED] space-y-5">
            <h2 className="text-[#098AD2] font-semibold">Banda Aceh</h2>
            <p className="">
              Jl. Blang Bintang Krueng Raya, Desa/Kelurahan Data Makmur, Kec.
          ...
          <div className="w-full pl-6 border-l-2 border-l-[#77C3ED] space-y-5">
            ...
            <p className="">
              Jl. Elak, Desa Jeulikat Kec. Blang Mangat, Kota Lhoksemauwe 24375
            </p>
          </div>
          <div className="w-full pl-6 border-l-2 border-l-[#77C3ED] space-y-5">
            <h2 className="text-[#098AD2] font-semibold">Rantau Prapat</h2>
            <p className="">
              Komp. Pergudangan Kesuma Wijaya Jl. H. Adam Malik / Jl. By Pass
              No. 1,2,3 Blok III Kel. Sirondurung, Kec. Rantau Utara
            </p>
          </div>
          <div className="w-full pl-6 border-l-2 border-l-[#77C3ED] space-y-5">
            <h2 className="text-[#098AD2] font-semibold">Langsa</h2>
            <p className="">
              Jl. A. Yani, Ruko No 1 s/d 6, Kel. Birem Puntong, Kec. Langsa Baro
              - Kota Langsa 24415
            </p>
          </div>
        </div>
