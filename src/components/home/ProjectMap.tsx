      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="w-full text-black md:my-32 md:w-1/2">
          <div className="flex justify-between">
            <div>
              <h1 className="text-base font-semibold md:text-3xl">{Translator.t("headquarter", lang)}</h1>
            ...
            <div>
              <h1 className="text-base font-semibold md:text-3xl">{Translator.t("branches", lang)}</h1>
              <ul className="mt-2 ml-10">
                <li className="text-base font-medium text-blue-500 list-disc">
          ...
          <div className="mt-10">
            <h1 className="text-base font-semibold md:text-3xl">{Translator.t("stations", lang)}</h1>
